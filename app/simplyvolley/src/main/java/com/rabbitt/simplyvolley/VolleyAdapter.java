...
public class VolleyAdapter {
    ...
    public void insertData(final Map<String, String> user_data, String url, final ServerCallback callback)
    {
    ...
    public void getData(final Map<String, String> user_data, String url, final ServerCallback callback)
    {
        Log.i(TAG, "VolleyAdapter: "+user_data.toString());
